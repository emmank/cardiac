...
//$result .= $vl['#title'];
$result .= '<a id="toggle-asuperiorhidden-div" href="#toggle-asuperiorhidden-div">Artery </a><br />';
$result .= '<a id="toggle-vsuperiorhidden-div" href="#toggle-vsuperiorhidden-div">Vena </a>';
$result .= '<div id="asuperiorhidden-div" style="display: none">';
...
$result .= '<div id="vsuperiorhidden-div" style="display: none">';
$result .= '<table width=100% class="table" border="1">' . "\n";
foreach($vl['datafields'] as $yk => $lv){
    if($lv['#type'] != 'hidden'){
        if(isset($lv['#customized'])){
