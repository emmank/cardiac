...
$result .= $vl['datafields']['video']['title'];
...
//        $result .= '<td>' . ucwords (str_replace ("_"," ", $lv['title'])) . '</td>';
        ...
        if($lv['type'] == 'textarea'){
            if($lv['readonly'] == '1'){
//                $result .= $lv['value'] . "\n";
                $result .= '<textarea name="' . $yk . '" cols="40" rows="6" readonly="true">' . $lv['value'] . '</textarea>' . "\n";
            } else {
                $result .= '<textarea name="' . $yk . '" cols="40" rows="6"></textarea>' . "\n";
            }
            ...
            if($lv['readonly'] === true){
                $result .= '<a href="' . $lv['value'] . '">' . $lv['title'] . '</a>';
            } else {
